...
description: "Highlights from the two-session workshop hosted by the Future Developers Club, covering Git basics, GitHub collaboration"
date: 2024-11-8
tags: ["git", "github"]
published: true
---

The Future Developers Club recently hosted an exciting two-session workshop on Git and GitHub,
